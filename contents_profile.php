	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/AIG/home.php"><span>AIG </span> ADMIN PAGE</a>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="/AIG/"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Logout</a></li>
						</ul>
					</li>
				</ul>
			...
			<div class="modal-body">
				...
				<form name="frm" role="form" method="get" action="modify_user_proc.php">
						...
						<label>패스워드확인 </label>
							...
							<input class='form-control' type='hidden' name = 'admin_idx'	value='<?php echo $info['admin_idx']?>'	style='background-color:'>
