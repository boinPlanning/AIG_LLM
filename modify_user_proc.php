...
<meta name="author" content="AIG관리자 시스템" />


<link href="/AIG_ADMIN/css/bootstrap.min.css" rel="stylesheet">

<link href="/AIG_ADMIN/css/datepicker3.css" rel="stylesheet">
<link href="/AIG_ADMIN/css/styles.css" rel="stylesheet">


<link href="/AIG_ADMIN/css/bootstrap-table.css" rel="stylesheet">
<link href="/AIG_ADMIN/css/bootstrap-table.css" rel="stylesheet">

<script src="/AIG_ADMIN/js/lumino.glyphs.js"></script>

<script type="text/javascript" src="/AIG_ADMIN/js/loader.js"></script>
...
if($info==Null) {
		echo "<script>
				...
				parent.location.replace('/AIG_ADMIN/');
			 </script> ";
}else {
	...
	if($info['admin_pw']==MD5($admin_pw)){
			...
			echo "<script>
				alert('환영합니다.');
				parent.location.replace('/AIG_ADMIN/home.php');
			</script> ";
